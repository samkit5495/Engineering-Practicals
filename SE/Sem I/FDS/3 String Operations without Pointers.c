//				Assigment 3 (a)
//				String Manipulation without pointers
/*
Name - Samkitkumar H. Jain
Date of Performance : 18/7/14
Write a program to perform following  operations on string using functions without pointers
1. Length
2. Copy
3. Concate
4. Compare
...
void mystrcpy(char a[20],char b[20])
{
	int i;
	for(i=0;a[i]!='\0';i++)
		b[i]=a[i];
...
void mystrcat(char a[20],char b[20])
{
	int i=mystrlen(a),j;
	for(j=0;b[j]!='\0';j++)
	{
...
int mystrcmp(char a[20],char b[20])
{
	int i=0;
...
/*
int substring(char a[20],char b[20])
{
